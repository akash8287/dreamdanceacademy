/**
 * Single source of truth for dance/style images from assets/newpics.
 * Home and Classes pages import from here so the same style always shows the same image.
 */

// Dance style images (same image for same style on Home and Classes)
...
// Studio / branding (for Home, Gallery, etc.)
import logoImage from '../../assets/newpics/WhatsApp Image 2026-01-29 at 11.30.41.jpeg' // DDA Logo
...
const extraImage2 = classicalImage // Ballet
const extraImage3 = coupleDanceImage // Belly Dance
const extraImage4 = houseDanceImage // House Dance (class)
const extraImage5 = freestyleImage // K-Pop
const extraImage6 = poppingImage   // Krumping
